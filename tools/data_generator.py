...
# Stable defaults keep generated fixtures reproducible across machines and runs.
DEFAULT_SEED = 42
...
class DataGenerator:
    def __init__(self, seed: int = DEFAULT_SEED, base_time_ms: int = DEFAULT_BASE_TIME_MS):
